...
def fetch_column_info(layout_res, img_width, img_height):
    # Sort all elements by their x-coordinate
    ...
    # Get column widths for 'sub column' category
    col_widths = [
    ...
    if col_widths:
        ...
        col_width = img_width  # Default column width if no 'sub column' found
        logger.warning("No 'sub column' found. Default column width applied.")

    # Assign modules to columns
    col_left = img_width
    cur_col = 1
